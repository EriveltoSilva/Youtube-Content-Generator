...
def generate_script(prompt, video_length, creativity, api_key):
    ...
    script_template = PromptTemplate(
        ...
        template="Create a script for a YouTube video based pn this title for me. TITLE:{title} of duration: {duration} minutes using this search data {DuckDuckGo_Search}"
    )
